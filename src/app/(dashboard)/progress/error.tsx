...
export default function ProgressError({
  ...
  useEffect(() => {
    console.error('Progress page error caught:', error)
  }, [error])
    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] p-6 text-center">
      ...
      >
        <div className="flex flex-col items-center gap-3">
          ...
          <h2 className="text-xl font-bold text-slate-100">Analytics load nahi ho saka</h2>
          <p className="text-xs text-slate-400 leading-relaxed">
            Practice logs retrieve karne ya streak details mapping process crash ho gaya hai. Dobara check karein.
          </p>
        </div>
