...
export default function VocabularyError({
  ...
  useEffect(() => {
    console.error('Vocabulary page error caught:', error)
  }, [error])
    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] p-6 text-center">
      ...
      >
        <div className="flex flex-col items-center gap-3">
          ...
          <h2 className="text-xl font-bold text-slate-100">Vocabulary builder error</h2>
          <p className="text-xs text-slate-400 leading-relaxed">
            Flashcards load hone me ya database review updates save hone me dikkat aayi hai.
          </p>
        </div>
